...
class Help(commands.Cog):
    ...
    async def help_command(self, ctx):
        ...
        embed.add_field(name="🎮 GAMES", value="!games · !arcade · !dailies · !claimdaily · !gamestats · !gameleaderboard · !ttt · !connect4 · !dicebattle · !trivia · !rps · !roll · !guess · !coinflip · !slots · !blackjack · !8ball · !chamber", inline=False)
