...
class Help(commands.Cog):
    ...
    async def help_command(self, ctx):
        ...
        embed.add_field(name="🎮 GAMES", value="!games · !roulette · !mines · !war · !baccarat · !higherlower · !oddeven · !target · !reaction · !scramble · !hangman · !mastermind · !trivia · !rps · !roll · !guess · !coinflip · !slots · !blackjack · !8ball · !chamber", inline=False)
