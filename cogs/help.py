...
class Help(commands.Cog):
    ...
    async def help_command(self, ctx):
        ...
        embed.add_field(name="🎮 GAMES", value="!games · !arcade · !trivia · !rps · !roll · !guess · !coinflip · !slots · !blackjack · !8ball · !ttt · !connect4 · !dicebattle · !dailies · !claimdaily · !gamestats · !arcadeprofile · !gameleaderboard · !tournament", inline=False)
