...
MATERIALS = {
    ...
    "copper_ore": {"name": "Copper Ore", "icon": "🟠", "description": "Soft ore gathered from the Moonlit Vale."},
    "moonstone": {"name": "Moonstone", "icon": "🌙", "description": "A pale stone carrying lunar energy."},
    "iron_ore": {"name": "Iron Ore", "icon": "⛓️", "description": "Raw iron ore from the Whispering Wood."},
    "ash_ore": {"name": "Ash Ore", "icon": "🖤", "description": "Heat-darkened ore from the Ashen Crown."},
    "astral_ore": {"name": "Astral Ore", "icon": "🌌", "description": "Star-touched ore from the Starfall Coast."},
    "softwood": {"name": "Softwood", "icon": "🪵", "description": "Common timber from the Moonlit Vale."},
    "thornwood": {"name": "Thornwood", "icon": "🌿", "description": "Dense living wood from the Whispering Wood."},
    "charred_wood": {"name": "Charred Wood", "icon": "🔥", "description": "Fire-scorched timber from the Ashen Crown."},
    "starwood": {"name": "Starwood", "icon": "✨", "description": "Luminous timber touched by starlight."},
    "wolf_fang": {"name": "Wolf Fang", "icon": "🦷", "description": "A fang collected from a realm wolf."},
    "pale_hide": {"name": "Pale Hide", "icon": "🪽", "description": "A pale hide from a Moonlit Vale beast."},
    "beast_hide": {"name": "Beast Hide", "icon": "🐾", "description": "Durable hide gathered in the forest."},
    "drake_scale": {"name": "Drake Scale", "icon": "🐉", "description": "A heat-resistant scale from an ash drake."},
    "star_hide": {"name": "Star Hide", "icon": "🌠", "description": "A hide marked by celestial energy."},
    "leviathan_scale": {"name": "Leviathan Scale", "icon": "🌊", "description": "A rare scale from a celestial leviathan."},
    "silverfish": {"name": "Silverfish", "icon": "🐟", "description": "A shimmering fish from the Moonlit Vale."},
    "forest_trout": {"name": "Forest Trout", "icon": "🐟", "description": "Fresh trout from the forest waters."},
    "emberfish": {"name": "Emberfish", "icon": "🔥", "description": "A warm-bodied fish from volcanic waters."},
    "starfish": {"name": "Starfish", "icon": "⭐", "description": "A luminous fish from the Starfall Coast."},
